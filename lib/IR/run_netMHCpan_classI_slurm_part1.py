...
def run_netMHCpan_classI_slurm_part1(input_list_path, HLAclass_path, HLAtypes_path, input_sequence_pieces_path, output_netMHC_path,
    ...
    try:
        ...
        # output_netMHC_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_files"
        # output_peptides_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_neoantigens_type_3.tab"
        # output_peptides_all_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_neoantigens_type_3_all.tab"
        # output_peptides_path2 = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_neoantigens_type_2.tab"
        # output_peptides_all_path2 = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_neoantigens_type_2_all.tab"
        # output_list_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_IR/IR_NetMHCpan-4.0_junctions_ORF_filtered_neoantigens.tab"
            ...
            for line in f:
                ...
                if (sample in HLA_samples):
                    ...
                    for x in HLA_types:
                        ...
                        open_peptides_file.write("#SBATCH --partition=short\n")
