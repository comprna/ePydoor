...
run_netMHCpan-4.0: run netMHCpan-4.0 on each sample
"""
...
def run_netMHCpan_classI_slurm_part2(input_list_path, HLAclass_path, HLAtypes_path, input_sequence_pieces_path, output_netMHC_path,
    ...
    try:
        ...
        # HLAtypes_path = "/projects_rg/SCLC_cohorts/tables/NetMHCpan-4.0_HLA_types_accepted.tab"
        # input_sequence_pieces_path = "/projects_rg/SCLC_cohorts/Smart/Exonizations_v2/exonization_fasta_files_v2"
        # output_netMHC_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_files"
        # output_peptides_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_neoantigens_type_3.tab"
        # output_peptides_all_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_neoantigens_type_3_all.tab"
        # output_peptides_path2 = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_neoantigens_type_2.tab"
        # output_peptides_all_path2 = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_neoantigens_type_2_all.tab"
        # output_list_path = "/users/genomics/juanluis/SCLC_cohorts/cis_analysis/netMHCpan-4.0_exonizations/exonizations_NetMHCpan-4.0_junctions_ORF_filtered_neoantigens.tab"
        # netMHC_path = "/users/genomics/juanluis/Software/netMHCpan-4.0/netMHCpan"
        ...
        # output_netMHC_path = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_files"
        # output_peptides_path = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_neoantigens_type_3.tab"
        # output_peptides_all_path = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_neoantigens_type_3_all.tab"
        # output_peptides_path2 = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_neoantigens_type_2.tab"
        # output_peptides_all_path2 = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_neoantigens_type_2_all.tab"
        # output_list_path = "/projects_rg/SCLC_cohorts/George/PSI_Junction_Clustering_v2/exonizations_NetMHCpan-4.0_junctions_ORF_filtered_neoantigens.tab"
        # netMHC_path = "/projects_rg/SCLC_cohorts/soft/netMHCpan-4.0/netMHCpan"
            ...
            for line in f:
                ...
                if (sample in HLA_samples):
                    ...
                    for x in HLA_types:
                        ...
                        cont2 += 1
                        # command = netMHC_path + " -BA -a " + x + " -l 8,9,10,11 " + input_sequence_pieces_path + "/" + index + \
                        ...
                        for element, values in ref_good_binders.items():
                            if (element not in ex_binders):
                                ...
                                open_peptides_file2.write(exonization+"\t"+sample+"\t"+x+"\t"+element+"\t"+
                                                                 str(values)+"\n")
